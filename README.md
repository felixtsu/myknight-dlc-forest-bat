...
> 在 [https://felixtsu.github.io/myknight-dlc-forest-bat/](https://felixtsu.github.io/myknight-dlc-forest-bat/) 打开此页面
...
* 点击 **新项目**
* 点击齿轮图标菜单下的 **扩展**
* 搜索 **https://github.com/felixtsu/myknight-dlc-forest-bat** 并导入

## 编辑此项目 ![构建状态标志](https://github.com/felixtsu/myknight-dlc-forest-bat/workflows/MakeCode/badge.svg)

在 MakeCode 中编辑此仓库。

* 打开 [https://arcade.makecode.com/](https://arcade.makecode.com/)
* 点击 **导入**，然后点击 **导入 URL**
* 粘贴 **https://github.com/felixtsu/myknight-dlc-forest-bat** 并点击导入
...
![块的渲染视图](https://github.com/felixtsu/myknight-dlc-forest-bat/raw/master/.github/makecode/blocks.png)
